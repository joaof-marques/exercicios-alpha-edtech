...
print(aplica_funcao_arbitraria(tudo_maiusculo, "Olá! Essa é uma string de TestE"))
print(aplica_funcao_arbitraria(alterna_maiusculo_minusculo, "Olá! Essa é uma string de TestE"))